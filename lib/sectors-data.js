export const sectorsData = {
  ...
  healthcare: {
    ...
    tagline: "Protecting patient data and clinical systems",
    heroDesc: "Healthcare organisations face unique identity security challenges — from legacy clinical systems and third-party clinical access to DSPT compliance and NHS Cyber Essentials. We help NHS Trusts and private healthcare providers build robust, compliant identity security programmes without disrupting care delivery.",
    challenges: [
      {
        title: "DSPT Compliance",
        desc: "Meeting the Data Security and Protection Toolkit requirements demands structured evidence of identity controls, access governance and staff training — we help you build and evidence that capability.",
        icon: "ClipboardCheck",
      },
      {
        title: "Legacy Clinical Systems",
        desc: "Many clinical systems pre-date modern authentication standards. We design pragmatic access controls that secure legacy environments without disrupting clinical workflows.",
        icon: "Server",
      },
      {
        title: "Third-Party Clinical Access",
        desc: "Contractors, locums, agency staff and vendors all need time-limited, appropriately scoped access. Uncontrolled third-party access is a major exposure — we help you govern it.",
        icon: "Users",
      },
      {
        title: "Insider Risk and Data Access",
        desc: "Healthcare data is high-value. Monitoring privileged access, detecting anomalous behaviour and enforcing least-privilege across clinical and administrative systems is a core capability we build.",
        icon: "ShieldAlert",
      },
    ],
    compliance: ["DSPT", "CQC Standards", "NHS Cyber Essentials", "UK GDPR", "ISO 27001"],
    caseStudy: {
      result: "Achieved 100% MFA coverage across 8,000 clinical staff with zero downtime",
      org: "NHS Trust",
      service: "IAM Assessment + Implementation",
    },
    stats: [
      { value: "100%", label: "MFA coverage" },
      { value: "0", label: "Clinical downtime" },
      { value: "DSPT", label: "Standard met" },
    ],
  },
};
